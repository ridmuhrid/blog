...
<!--</div>-->
<div id="bar"><h2>Kunci Jawaban Webinar Lainnya</h2></div>
<div class="kunci">
<a href="https://muhrid.com/website-yang-menyediakan-skp-iai-gratis/">Kumpulan Website yang Menyediakan SKP IAI Gratis</a>
<?php 
if(false===($level=get_transient('webinar'))){$level=new WP_Query(array('tag'=>'kunci-jawaban-webinar-iai','post_type'=>'post','post_status'=>'publish','posts_per_page'=>9,'order'=>'DESC'));set_transient('webinar',$level,DAY_IN_SECONDS);}
get_transient('webinar');
while($level->have_posts()){$level->the_post();echo'<a href="'.get_the_permalink().'">'.get_the_title().'</a>';}?><a href="https://muhrid.com/tag/kunci-jawaban-webinar-iai/">Kunci Jawaban Webinar Lainnya</a></div>
</div>
...
<div class="share">
<p>Silakan bagikan kunci jawaban webinar ini kepada rekan sejawat yang lain.</p>
...
<a href="https://t.me/CPDapoteker"><div class="join"><h3>Gabung grup Telegram</h3><p>Berbagi informasi kegiatan webinar dan kunci jawaban post test webinar</p></div></a>
</article>
</main>
<footer>
