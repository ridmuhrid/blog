...
<div>
<a href="https://muhrid.com/webinar/"><span class="web-date"></span></a>
<p>Jadwal</p>
</div>
<div>
<a href="https://muhrid.com/jawabanP2AB/"><span class="web-key"></span></a>
<p>Jawaban</p>
</div>
<div class="home">
...
<div>
<a href="https://t.me/CPDapoteker"><span class="web-group"></span></a>
<p>Grup</p>
</div>
<div>
...
<div class="meta">
<span><span class="web-folder-open"></span> <?php echo strip_tags(get_the_term_list($post->ID,'kategori','<span>','</span><span>','</span>'),'<span>');?></span>
<span><span class="web-price-tag"></span> <?php echo get_post_meta(get_the_ID(),'biaya',true);?></span>
...
<span class="article" itemprop="articleBody">
<p>Webinar dengan judul <?php the_title()?> akan dilaksanakan pada <?php echo tgl_indo(date('N/m/j/Y',strtotime(get_post_meta(get_the_ID(),'tgl',true))));?> pukul <?php echo get_post_meta(get_the_ID(),'jam',true);?> WIB.</p>
<a href="<?php echo the_post_thumbnail_url('full');?>"><img src="<?php echo the_post_thumbnail_url('full');?>" alt="<?php the_title();?>" title="<?php the_title();?>"></a>
<p><b>Informasi tambahan dari panitia pelaksana:</b></p>
<blockquote>
<?php $thecontent=get_the_content();
if(!empty($thecontent)){the_content();}
else {echo "Belum atau tidak ada informasi tambahan dari panitia pelaksana.";}
?>
</blockquote>
<p>Link untuk pendaftaran atau informasi lebih lanjut dapat diakses melalui <a target="_blank" class="br" href="https://muhrid.com/go.php?url=<?php echo get_post_meta(get_the_ID(),'link',true);?>"><?php echo get_post_meta(get_the_ID(),'link',true);?></a>.</p>
</span>
...
?>
<div class="share">
<p>Informasi webinar ini diterbitkan pada <span content="<?php echo get_the_date('Y-m-d');?>"><?php echo get_the_date();?></span>.</p>
<p>Silakan bagikan informasi kegiatan webinar ini kepada teman-teman Anda.</p>
