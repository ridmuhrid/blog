...
<div class="share">
<p>Bagikan pembahasan soal ini kepada teman-teman Kamu.</p>
...
<div class="related">
<p class="jawab">Pembahasan soal lainnya</p>
<?php 
if(false===($relatedpost=get_transient('relatedpostsoal'))){
$relatedpost=new WP_Query(array('post_type'=>'soal','posts_per_page'=>10,'orderby'=>'rand'));
set_transient('relatedpostsoal',$relatedpost,(60*60));
}
get_transient('relatedpostsoal');
while($relatedpost->have_posts()){$relatedpost->the_post();?>
<a href="<?php the_permalink()?>" rel="bookmark" title="<?php the_title();?>"><?php the_title();?></a>
<?php }?>
<a href="https://muhrid.com/soal/" rel="bookmark" title="Arsip Soal">Lihat kumpulan pembahasan soal Lainnya</a>
</div>

<div class="metasoal">
<link itemprop="mainEntityOfPage" href="<?php echo get_permalink();?>" />
<meta itemprop="inLanguage" content="id_ID">
Pembahasan soal "<h1 class="headline" itemprop="headline"><?php the_title()?></h1>" diterbitkan pada <span content="<?php echo get_the_date('Y-m-d');?>"><?php echo get_the_date(); ?></span> oleh <span itemprop="author"><span itemscope="itemscope" itemtype="http://schema.org/Person"><span itemprop="name"><?php echo get_the_author();?></span></span></span>.
