...
<div class="article" itemprop="articleBody"><?php the_content();postview();?></div>
<div class="ads">
...
$cat=strtolower(str_replace(" ", "",$category[0]->cat_name));
$nama='relatedpost'.$cat;
if(false===($relatedpost=get_transient($nama))){
$relatedpost=new WP_Query(array('category__in'=>wp_get_post_categories($post->ID),'posts_per_page'=>5,'orderby'=>'rand'));
set_transient($nama,$relatedpost,(60*60));
}
get_transient($nama);
while($relatedpost->have_posts()){$relatedpost->the_post();?>
<a href="<?php the_permalink()?>" rel="bookmark" title="<?php the_title();?>"><?php the_title();?></a>
<?php }?>
<a href="<?php echo esc_url(get_category_link($category[0]->term_id));?>" rel="bookmark" title="<?php echo $category[0]->cat_name;?>">Artikel <b><?php echo $category[0]->cat_name;?></b> Lainnya</a>
</div>
