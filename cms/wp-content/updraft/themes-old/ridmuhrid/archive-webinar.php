...
<div id="intro">
<h1 itemprop="headline">Jadwal Webinar</h1>
<p>Simak jadwal kegiatan webinar hari ini. Daftar kegiatan webinar di bawah ini sudah diurutkan berdasarkan jadwal kegiatan terdekat yang akan dilaksanakan.</p>
...
if (!is_paged()){?>
<div>
<h2 class="webtit">Webinar Hari Ini</h2>
<div class="webinar">
<?php
...
<p><span class="web-url"></span> <a target="_blank" class="br" href="https://muhrid.com/go.php?url=<?php echo get_post_meta(get_the_ID(),'link',true);?>"><?php echo get_post_meta(get_the_ID(),'link',true);?></a></p>
<span class="category"><?php echo strip_tags(get_the_term_list($post->ID,'kategori','<span>','</span><span>','</span>'),'<span>');?></span>
<span class="category"><span><?php echo get_post_meta(get_the_ID(),'biaya',true);?></span></span>
</div>
</article>
<?php }}
else {echo '<article class="info">Tidak ada jadwal webinar hari ini.</article>';}?>
</div>
</div>
<?php } ?>

<div>
<h2 class="webtit">Webinar yang Akan Datang</h2>
<div class="webinar">
...
<div>
<h2 class="webtit">Webinar yang Telah Terlaksana</h2>
<div class="webinar">
<article class="info">Silakan lihat di halaman <a href="https://muhrid.com/database-webinar/">Database Kegiatan Webinar</a>.</article>
</div>
