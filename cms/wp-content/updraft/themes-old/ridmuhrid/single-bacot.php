...
<title>Bacotan MUHRID [<?php echo get_the_ID();?>]</title>
<meta name="description" content="<?php echo trim(preg_replace(array('/\\n/','/\./'),array('','. '),wp_filter_nohtml_kses(get_the_content())));?>" />
<meta name="robots" content="noindex,follow"/>
<meta property="fb:pages" content="462275083787417" />
<meta property="og:locale" content="id_ID" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Bacotan <?php echo get_the_ID();?>" />
<meta property="og:description" content="<?php echo trim(preg_replace(array('/\\n/','/\./'),array('','. '),wp_filter_nohtml_kses(get_the_content())));?>" />
...
<meta property="og:image:alt" content="Bacotan <?php echo get_the_ID();?>" />
...
<h1 itemprop="headline">Bacotan #<?php echo get_the_ID();?></h1>
<?php the_content();?>
</article>
<?php endwhile;?>
</div>
...
<?php comments_template('/comments-bacot.php');?> 
</div>
</div>
</div>
</main>
