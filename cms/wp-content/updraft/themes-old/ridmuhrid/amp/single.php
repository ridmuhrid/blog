...
<time itemprop="datePublished" datetime="<?php echo get_the_date('Y-m-d');?>T<?php the_time('H:i:sT');?>"></time>
<time itemprop="dateModified" datetime="<?php the_modified_date('Y-m-d');?>T<?php the_modified_time('H:i:sT');?>"><?php echo human_time_diff(get_the_modified_time('U'),current_time('timestamp')).' yang lalu';?></time>
</div>
</header>
...
<?php } else {?>
<?php echo $this->get('post_amp_content');postview();}?>
