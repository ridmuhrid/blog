...
<title>Arsip Hadist | Muhrid.com</title>
<meta name="description" content="Arsip hadits yang saya gunakan di dalam artikel kategori Islami." />
<meta property="fb:pages" content="462275083787417" />
<meta property="og:locale" content="id_ID" />
<meta property="og:type" content="object" />
<meta property="og:title" content="Arsip Hadits" />
<meta property="og:description" content="Arsip hadits yang saya gunakan di dalam artikel kategori Islami." />
<meta property="og:url" content="https://muhrid.com/hadits/" />
...
<div id="intro">
<div class="intro">
<h1 itemprop="headline">Arsip Hadits</h1>
<p>Arsip hadits yang saya gunakan di dalam artikel kategori Islami.<?php if(current_user_can('administrator')){echo '<br><a href="https://muhrid.com/wp-admin/post-new.php?post_type=hadits">[Tambah Baru]</a>';}?></p>
</div>
</div>
<div class="soal">
<?php 
...
$per_page='6';
$hadits_args=array('post_type'=>'hadits','posts_per_page'=>$per_page,'paged'=>$current_page);
$hadits=new WP_Query($hadits_args);
$i=1;
while($hadits->have_posts()):$hadits->the_post();?>
