...
<title>Bacotan MUHRID</title>
<meta name="description" content="Hanya sekedar curahan hati yang tidak tersampaikan lewat mulut." />
<meta property="fb:pages" content="462275083787417" />
<meta property="og:locale" content="id_ID" />
<meta property="og:type" content="object" />
<meta property="og:title" content="Bacotan MUHRID" />
<meta property="og:description" content="Hanya sekedar curahan hati yang tidak tersampaikan lewat mulut." />
<meta property="og:url" content="https://muhrid.com/bacot/" />
...
<meta property="og:image:alt" content="Bacotan MUHRID" />
...
<div id="intro">
<div class="intro">
<h1 itemprop="headline">Bacotan MUHRID</h1>
<p>Hanya sekedar curahan hati yang tidak tersampaikan lewat mulut.<?php if(current_user_can('administrator')){echo '<br><a href="https://muhrid.com/wp-admin/post-new.php?post_type=bacot">[Tambah Baru]</a>';}?></p>
</div>
</div>
<div class="bacotan">
<?php 
...
$per_page='6';
$bacot_args=array('post_type'=>'bacot','orderby'=>'modified','order'=>'DESC','posts_per_page'=>$per_page,'paged'=>$current_page);
$bacot=new WP_Query($bacot_args);
$i=1;
while($bacot->have_posts()):$bacot->the_post();?>
<div class="bacot">
<img src="https://muhrid.com/wp-content/themes/muhrid/amp/gravatar.jpeg" alt="Muhammad Riduan" width="24" height="24" />
<div class="text">
<?php the_content();?>
<span class="time">&#x1F550; <?php echo human_time_diff(get_the_time('U'),current_time('timestamp')).' yang lalu';?></a> | <a href="<?php echo get_permalink();?>">Beri komentar</a><?php if(!is_admin()){edit_post_link('Sunting ini',' | ','');}?></span>
</div>
</div>
<?php $i+=1;
endwhile;?>
