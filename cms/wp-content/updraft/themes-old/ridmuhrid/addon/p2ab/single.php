...
while($level->have_posts()){$level->the_post();echo'<a href="'.get_the_permalink().'">'.get_the_title().'</a>';}?><a href="https://muhrid.com/tag/kunci-jawaban-webinar-iai/">Kunci Jawaban Webinar Lainnya</a>
</div>
